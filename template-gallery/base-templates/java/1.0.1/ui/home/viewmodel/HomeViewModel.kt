package {{applicationId}}.ui.home.viewmodel
...
import {{applicationId}}.data.repository.items.ItemsRepository
import {{applicationId}}.domain.GetItemsWithTimeAgoUseCase
